...
filename = os.path.join(os.path.dirname(__file__), 'data/suicide_rates.csv')
...
app.layout = html.Div([
        html.Div([
            html.Pre(children= "Suicide Rates 1985-2016", id='title',
...
def update_graph(years_chosen):
    # print(years_chosen)
    new_title = f'Suicide Rates {years_chosen[0]}-{years_chosen[1]}'
